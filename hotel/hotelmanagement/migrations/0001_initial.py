# Generated by Django 2.1.7 on 2019-04-19 06:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking_folio_transfer_minibarcharge', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bk_folio_transfer_minibarcharge', to='hotelmanagement.Booking')),
                ('booking_folio_transfer_roomcharge', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bk_folio_transfer_roomcharge', to='hotelmanagement.Booking')),
            ],
        ),
        migrations.CreateModel(
            name='BookingPayment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price_confirm', models.IntegerField(default=0)),
                ('date_charge', models.DateTimeField(default=django.utils.timezone.now)),
